  ...
  return (
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          ...
          <Button
            ...
            className="gap-2 rounded-xl h-10 bg-[hsl(162,38%,11%)] hover:bg-[hsl(162,38%,14%)] text-white shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="sm:col-span-2 bg-[hsl(162,38%,11%)] rounded-2xl p-6">
          <p className="text-sm text-white/50 font-medium">Total Collectable</p>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="bg-[hsl(162,38%,11%)]">
                  <td colSpan={4} className="px-6 py-4 text-sm font-semibold text-white/50 text-right">Total Collectable</td>
